      ...
      <div className='flex justify-between items-center mt-8 lg:mt-16 flex-col lg:flex-row'>
        ...
        >
          <div className='font-extrabold text-2xl lg:text-5xl mt-5 lg:mt-0 space-y-1 lg:space-y-3'>
            <h2>Let's <span className='text-white' style={{ WebkitTextStroke: '1px black' }}>build</span> for</h2>
            <h2>Something impactful</h2>
          </div>

          <p className='text-[#71717A] text-sm/6 lg:text-base mt-3 lg:mt-6'>Have an idea, an opportunity, or just want to connect? I'm always open to discussing new projects, technology, and interesting problems. Feel free to reach out, and I'll get back to you as soon as I can.</p>

          <div className='font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4'>
            <motion.a
              whileHover={{ x: 5 }}
              className='flex items-center gap-2 group'
              href="mailto:01official.ravi@gmail.com"
            >
              <span className='border-2 transition-all border-transparent group-hover:border-black rounded-full p-1'>
                <IoMdMail className="w-4 h-4 lg:w-5 lg:h-5" />
              </span>
              01official.ravi@gmail.com
            </motion.a>

...
export default function Skills() {
  const skills = [
    ...
    { id: 2, name: "C++", icon: <FaDatabase size={50} /> },
  ...
  const [experiences] = useState([
    ...
    {
      id: 1,
      company: "VR Enterprises",
      role: "Software Development Intern",
      period: "Aug 2026 - Present",
      description:
        "Building an automated GeM Tender Discovery and Extraction Pipeline using Python, FastAPI, PostgreSQL, Apache Airflow, Docker, and LLM integrations. Working across bid discovery, document processing, data extraction, classification, and pipeline orchestration.",
      logo: "/assets/VR-Enterprises.jpg",
    },
  ]);
